...
public class ChannelScanFragment extends GuidedStepFragment {
    ...
    private List<Channel> scanChannel() {
        ...
        channels.add(createFakeChannel("Video-in", "9.1", 1));
    ...
    private void updateChannels(List<Channel> channels) {
        ...
        Cursor cursor =
                cr.query(
                        TvContractCompat.buildChannelsUriForInput(CameraTvInputService.INPUT_ID),
                        Channel.PROJECTION,
                        null,
                        null,
                        null,
    ...
    private Channel createFakeChannel(String name, String number, int networkId) {
        Channel channel =
                new Channel.Builder()
                        ...
                        .setInputId(CameraTvInputService.INPUT_ID)
    ...
    private void onChannelDetected(final Channel channel) {
        getActivity()
                .runOnUiThread(
                        new Runnable() {
                            @Override
