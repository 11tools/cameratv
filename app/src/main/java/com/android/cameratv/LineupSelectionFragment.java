...
public class LineupSelectionFragment extends GuidedStepFragment {
    ...
    private void onLineupSelected(@Nullable Lineup lineup) {
        ...
        values.put(EpgContract.EpgInputs.COLUMN_INPUT_ID, CameraTvInputService.INPUT_ID);
        values.put(EpgContract.EpgInputs.COLUMN_LINEUP_ID, lineup.getId());

        ContentResolver contentResolver = getActivity().getContentResolver();
        EpgInput epgInput = EpgInputs.queryEpgInput(contentResolver, CameraTvInputService.INPUT_ID);
        if (epgInput == null) {
