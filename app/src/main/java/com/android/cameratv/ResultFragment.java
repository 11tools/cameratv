...
import com.android.cameratv.LineupSelectionFragment;
...
public class ResultFragment extends GuidedStepFragment {
    ...
    public void onGuidedActionClicked(GuidedAction action) {
        ...
        switch ((int) action.getId()) {
            ...
            case (int) GuidedAction.ACTION_ID_FINISH:
                setResultAndFinishActivity(CameraTvInputService.INPUT_ID);
    ...
    private void setResultAndFinishActivity(String inputId) {
        ...
        getActivity().finishActivity(CameraTvInputSetupActivity.REQUEST_CODE_START_SETUP_ACTIVITY);
    }
}
